...
jest.mock('src/views/explore', () => ({
  __esModule: true,
  default: () =>
    React.createElement('div', { 'data-testid': 'explore' }, 'Explore'),
}));
jest.mock('src/views/user', () => ({
  __esModule: true,
  default: () => React.createElement('div', { 'data-testid': 'user' }, 'User'),
}));
jest.mock('src/views/community', () => ({
  __esModule: true,
  default: () =>
    React.createElement('div', { 'data-testid': 'community' }, 'Community'),
}));
jest.mock('src/views/channel', () => ({
  __esModule: true,
  default: () =>
    React.createElement('div', { 'data-testid': 'channel' }, 'Channel'),
}));
...
jest.mock('src/views/pages', () => ({
  __esModule: true,
  default: () =>
    React.createElement('div', { 'data-testid': 'pages' }, 'Pages'),
}));
...
jest.mock('src/views/thread', () => ({
  __esModule: true,
  ThreadView: () =>
    React.createElement('div', { 'data-testid': 'thread-view' }, 'ThreadView'),
}));
jest.mock('src/views/newUserOnboarding', () => ({
  __esModule: true,
  default: () =>
    React.createElement('div', { 'data-testid': 'onboarding' }, 'Onboarding'),
}));
