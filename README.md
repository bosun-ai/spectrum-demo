...
We are deeply grateful to the following people for their contributions to this project. Thank you for your time, attention, and support — your involvement has helped move this work forward.
...
References
- The contributors list above was taken directly from the retrieved context provided with this task (the author entries supplied in the prompt).
