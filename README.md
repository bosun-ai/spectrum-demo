...
>
> \- [Guillermo Rauch (@rauchg)](https:[redacted])
...
If you want to implement a new feature, open an issue first to discuss what it'd look like and to ensure it fits in our roadmap and plans for the app (see [the main project board](https:[redacted]) for planned and currently ongoing work).
...
If you get `Permission denied` error using `ssh` refer [here](https:[redacted])
...
We extend our sincere thanks to everyone who has contributed to this project. Your time, code, bug reports, ideas, reviews, and encouragement have made this work possible. This project exists because of your collective efforts — thank you.
...
References
- The contributor names and emails above are taken from the provided author list in the retrieved context (the list of contributors supplied as part of the prompt).

## GitHub

Spectrum is now part of GitHub. For code of conduct, please see [GitHub's Community Guidelines](https:[redacted]) and [Acceptable Use Policies](https://help.github.com/en/github/site-policy/github-acceptable-use-policies).
