...
We warmly thank the following people for their contributions to this project. Your time, code, reviews, ideas, and encouragement have helped make this project better — we greatly appreciate each and every contribution.
...
References
- The contributor names and contact information above are taken directly from the retrieved context provided with this request (the list of authors supplied to the assistant).
